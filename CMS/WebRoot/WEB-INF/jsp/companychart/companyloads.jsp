...
<html>
  ...
  <body class="easyui-layout">
    <div id="body" region="center"  hide="true"  split="true" title="公司设备负荷率" style="background: witch; height: 335px;">
		...
		<div><h2>${str }</h2></div>
		<div id="explain" style="table-layout: fixed; width:18%; float:left;margin-top: 120px;margin-left:10px;border:1px solid red;">
		按组织机构和日期对设备负荷率趋势统计:<br/>
		统计时间段内的各部门设备负荷率趋势；<br/>
		负荷率=设备正常工作时间/(8*60*60)/正常工作焊机数量<br/>
		X轴:日期<br/>
		Y轴:负荷率<br/></div>
		<div id="companyLoadsChart" style="height:300px;width:65%; margin: 21%;margin-bottom: 20px; margin-top: 20px;"></div>
