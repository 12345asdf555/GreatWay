...
<html>
  ...
  <body class="easyui-layout">
    ...
    <div id="body" region="center"  hide="true"  split="true" title="事业部焊口焊接工时" style="background: witch; height: 335px;">
		...
		<div><h2>${str }</h2></div>
		<div id="caustHourChart" style="height:300px;width:50%; margin: auto;margin-bottom: 20px; margin-top: 20px;float:left;"></div>
