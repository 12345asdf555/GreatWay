...
function CausttimeDatagrid(){
	...
	var column = new Array();
         ...
         success : function(result) {  
             if (result) {
                 ...
                 for(var m=0;m<result.arys1.length;m++){
                	 column.push({field:"a"+m,title:"<a href='itemChart/goItemOvertime?parent="+result.arys1[m].itemid+"&parentime1="+dtoTime1+"&parentime2="+dtoTime2+"'>"+result.arys1[m].name+"(次)</a>",width:width,halign : "center",align : "left"});
	 ...
	 $("#caustOvertimeTable").datagrid( {
			fitColumns : true,
			height : $("#body").height() - $("#caustOvertimeChart").height()-$("#caustOvertime_btn").height()-40,
			width : $("#body").width(),
			idField : 'id',
			pageSize : 10,
