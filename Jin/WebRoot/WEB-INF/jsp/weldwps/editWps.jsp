...
<div  id="body" region="center"  hide="true"  split="true" title="修改工艺" style="background: white; height: 335px;">
    <div id="toolbar" style="text-align: center ">
       <form action="" id="fm" method="post" data-options="novalidate:true" style="margin:0;padding:20px 50px">
            <div style="margin-bottom:20px;font-size:14px;border-bottom:1px solid #ccc">工艺编辑</div>
            ...
            <div class="fitem">
				...
				<select class="easyui-combobox" name="Fowner" id="Fowner" value="${wps.fowner}" data-options="required:true"></select>
        	</div>
			<div class="fitem">
            	<lable>备注</lable>
