...
function openUser(){
	addTab("用户管理","user/AllUser","icon-35");
}

function openRole(){
	addTab("角色管理","role/AllRole","icon-35");
}

function openAuthority(){
	addTab("权限管理","authority/AllAuthority","icon-35");
}

function openResource(){
	addTab("资源管理","resource/AllResource","icon-35");
}

function openInsframework(){
	addTab("组织机构管理","insframework/goInsframework","icon-38");
}

function openDictionary(){
	addTab("字典管理",'Dictionary/goDictionary',"icon-38");
}

function openCompanytEfficiency(){
	addTab("焊工工效","companyChart/goCompanyEfficiency","icon-59");
}

function openCompanyUse(){
	addTab("单台设备运行数据统计","companyChart/goCompanyUse","icon-62");
}
function openMachine(){
	addTab("维修记录管理","maintain/goMaintain","icon-38");
}

function openCompanyovertime(){
	addTab("超时待机统计","companyChart/goCompanyOvertime","icon-62");
}
function openCompanyIdle(){
	addTab("设备闲置率","companyChart/goCompanyIdle","icon-62");
}
function openWeldParameter(){
	addTab("焊接参数维度表","rep/weldpara","icon-69");
}

function openWireUse(){
	addTab("焊丝用量维度表","rep/wireuse","icon-69");
}

function openWelderReport(){
	addTab("焊工维度表","rep/welderreport","icon-69");
}

function openParameter(){
	addTab("参数设置","Dictionary/goParameter","icon-42");
}

function openProduct(){
	addTab("产品管理","product/AllProduct","icon-38");
}

function openWps(){
	addTab("工艺管理","wps/AllWps","icon-38");
}
