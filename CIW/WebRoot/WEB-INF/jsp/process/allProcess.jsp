  ...
  <body  class="easyui-layout" style="background:#ffffff;">
   ...
   <div id="body" region="center"  hide="true"  split="true" style="background: #eee; height: 335px;margin-top:70px;">
        ...
        <div id="toolbar" style="margin-bottom: 5px;">
        	<a href="javascript:addProcess()" class="easyui-linkbutton" iconCls="icon-add">新增</a>
        	<a href="javascript:insertSearchProcess();" class="easyui-linkbutton" iconCls="icon-search">查找</a>
    	</div>
    		<!-- 自定义多条件查询 -->
