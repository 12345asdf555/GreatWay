  ...
  <body  class="easyui-layout" style="background:#ffffff;">
   ...
   <div id="body" region="center"  hide="true"  split="true" style="background: #ffffff; height: 335px;margin-top:70px;">
        ...
        <div id="toolbar" style="margin-bottom: 5px;">
        	...
        	<a href="javascript:giveWps()" class="easyui-linkbutton" iconCls="icon-edit">工艺下发</a>
        	<a href="javascript:history()" class="easyui-linkbutton" iconCls="icon-search" >下发历史</a>
    	</div>
